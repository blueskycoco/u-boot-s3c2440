...
//Timing parameter for NEC3.5"
#define VBPD_640480		(32)		
#define VFPD_640480		(9)
#define VSPW_640480		(1)

#define HBPD_640480		(47)
#define HFPD_640480		(15)
#define HSPW_640480		(95)  //Adjust the horizontal displacement of the screen :tekkamanninja@163.com
				      //+ ： -->    - : <--
...
{ 
	...
	lcd->LCDCON1 = 0x00000178; /* CLKVAL=4, BPPMODE=16bpp, TFT, ENVID=0 */ 
	lcd->LCDCON2 = (VBPD_640480<<24)|(LINEVAL_TFT_640480<<14)|(VFPD_640480<<6)|(VSPW_640480); 
	lcd->LCDCON3 = (HBPD_640480<<19)|(HOZVAL_TFT_640480<<8)|(HFPD_640480); 

	lcd->LCDCON4 = (MVAL<<8)|(HSPW_640480);
